...
// ============================================================================
// LED Character Patterns
// ============================================================================

/// Returns a 5x7 LED dot matrix pattern for a character
///
/// Each character is represented as 7 rows of 5 bits (stored as u8).
/// Bit 1 = LED ON, Bit 0 = LED OFF
///
/// # Arguments
/// * `c` - Character to convert to LED pattern
///
/// # Returns
/// Array of 7 bytes representing rows (MSB = leftmost pixel)
///
/// # Example Pattern
/// For 'A':
/// ```text
...
/// 10001  →  0b10001
/// ```
fn get_led_char_pattern(c: char) -> [u8; 7] {
    match c {
        'A' => [
